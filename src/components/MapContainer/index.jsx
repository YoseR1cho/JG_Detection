...
const  MapContainer = ()=> {
    ...
    useEffect(() => {
        AMapLoader.load({
            ...
            plugins: ["AMap.AutoComplete","AMap.PlaceSearch","AMap.ElasticMarker","AMap.Geocoder"], // 需要使用的的插件列表，如比例尺'AMap.Scale'等
        })
            .then((AMap) => {
        ...
        <div className={styles.mask}>
            <div className={styles.modal}>
                ...
                <div
                    ...
                    style={{ height: "800px" }}
                ></div>
                <Input addonBefore='地点' size={"large"} value={value} onChange={e=>setValue(e.target.value)}/>
                <Button loading={loading} mark={mark} value={value} >确定</Button>
            </div>
        </div>
    );
}
