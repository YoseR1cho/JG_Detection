...
import {receiveWorkSheet} from "@/utils/api.js";
...
const ReceiveModal = ({data}) => {
    ...
    return (
        <>
            <Button className={styles.blueBtn} onClick={showReceiveModal}>接单</Button>
            <Modal
                title="确认接单"
                open={isOpen}
                ...
                footer={
                    <>
                        ...
                        <Button className={styles.greenBtn} onClick={handleReceive}>确认</Button>
                    </>
                }
            ...
            >
                ...
                <div className={styles.modal}>
                    <span>识别等级:
                        <span>{data.riskLevel}</span>{data.risk}
                    </span>
